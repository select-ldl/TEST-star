...
<table width="782" border="1" bordercolor="#99CCFF" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
  ...
  <tr>
    ...
    <jsp:include page="sales_promotion.jsp" flush="true"/></td>
...
%>
  ...
  <% 
   ...
   %>
    ...
    </p><p class="STYLE1"><%= p_name %></p>
    <font size="2" color="#FF0000">￥<%= p_price %></font></p>   
	...
	<input name="see" type="button" class="btn_grey" onClick="window.location.href='cart_add.jsp?p_id=<%=p_id%>'" value="购买"><% } %></p>
   </td>
    <% 
			}
